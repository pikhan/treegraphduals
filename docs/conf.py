...
# NB: name it _package_version -- a module-level `version` here would be read by
# Sphinx as its own `version` config value.
release = _package_version("treegraphduals")
...
import numpy as np
from treegraphduals.core import BinaryTree, Tree
"""
...
exclude_patterns = ["_build", "Thumbs.db", ".DS_Store", "adr/template.md"]
